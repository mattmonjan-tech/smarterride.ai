...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-slate-100 text-slate-900 font-sans animate-in fade-in duration-300">
      ...
      {showMaintenanceModal && <MaintenanceModal isOpen={showMaintenanceModal} onClose={() => setShowMaintenanceModal(false)} onSubmit={(ticket) => setMaintenanceTickets(prev => [ticket, ...prev])} routes={routes} />}
    </div>
  );
}
